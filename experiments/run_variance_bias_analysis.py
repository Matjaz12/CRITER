...
from analysis import VarianceBiasAnalysis
...
def evaluate(
    ...
    for observation, missing_mask in test_dataloader:
        ...
        for idx in range(num_test_runs):
            ...
            vba.update(target, rec, var, land_mask, missing_mask, sampled_mask)

    print(f"exporting VE result...", flush=True)
    vba.export(os.path.join(out_path, "ve_result.json"))
