#!/bin/sh
#SBATCH --job-name=test_criter              # the title of the job
...
OUT_PATH="./output/test_criter"
MODEL_PATH="./output/train_criter/CRITER.pt"
srun --nodes=1 --exclusive --gres=gpu:1 --ntasks=1 python3 test_criter.py \
    --data_path=$DATA_PATH \
...
cp slurm_out.log $OUT_PATH/test_criter.log
